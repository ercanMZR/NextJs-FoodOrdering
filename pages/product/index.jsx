...
const Index = () => {
    ...
    const handleChange =(e,item)=>{const checked=e.target.checked;
...
Lorem ipsum dolor, sit amet consectetur adipisicing elit. Corrupti quis perspiciatis provident hic adipisci architecto vero, quo necessitatibus aliquid nostrum at eaque suscipit eligendi. Veritatis dicta iure voluptatem eius et.
            </p>
            <div>
            ...
            <div className='flex gap-x-4 my-6 md:justify-start justify-center'> 
                {extraItems.map((item)=>(
                    <label className='flex ' key={item.id}>
                        <input type="checkbox"
